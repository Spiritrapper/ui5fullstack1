sap.ui.define([
    ...
    return Controller.extend("ui5.walkthrough.controller.InvoiceList", {
        ...
        onNextPage: function () {
            ...
            // 페이지 업데이트 후 디버깅
            console.log("After Next: Current Page:", oViewModel.getProperty("/currentPage"));
            this._loadData();
        },
        ...
        onPreviousPage: function () {
            ...
            if (iCurrentPage > 0) {
                oViewModel.setProperty("/currentPage", iCurrentPage - 1);
                // 페이지 업데이트 후 디버깅
                console.log("After Previous: Current Page:", oViewModel.getProperty("/currentPage"));
