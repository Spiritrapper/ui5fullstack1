sap.ui.define([
    ...
    return Controller.extend("ui5.walkthrough.controller.RequestDetail", {
        ...
        onInit: function () {
            ...
            if (oGlobalModel) {
                oGlobalModel.setProperty("/isAdminMode", false);  // 기본값을 false로 설정
            }
        },
        ...
        _loadDetailData: function (sRequestNumber) {
            var sUrl = "https://port4005-workspaces-ws-z7sjw.us10.trial.applicationstudio.cloud.sap/odata/v4/request/Request(" + sRequestNumber + ")?$expand=request_state";
        ...
        _loadRequestStates: function () {
            var sUrl = "https://port4005-workspaces-ws-z7sjw.us10.trial.applicationstudio.cloud.sap/odata/v4/request/Request_state";
        ...
        onSave: function () {
            ...
            var sUrl = "https://port4005-workspaces-ws-z7sjw.us10.trial.applicationstudio.cloud.sap/odata/v4/request/Request(" + oData.request_number + ")";
